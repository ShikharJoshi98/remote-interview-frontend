...
export default function Navbar() {
    ...
    return (
        <header className="p-1 bg-black">
            <nav
                className="bg-gray-800/60 fixed z-10 left-1/2 -translate-x-1/2 w-[95%] max-w-6xl mx-auto top-2 flex items-center justify-between py-3 px-8 backdrop-blur-lg rounded-full">
                <div className="flex items-center gap-2 font-semibold">
                    ...
                    />
                    <h1 className="text-white text-2xl">Interview<span className="text-blue-400">Pro</span></h1>
                </div>
